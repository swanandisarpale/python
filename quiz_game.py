#object oriented, procedural o, virtual base, scripting base, functional bas
#there will be 4 sets in this game like type of quiz if you dont want all four
#then custom it user can make many 
#first the variables in the game what we will use then game loop ,game updations, what to show and not
def main(): 
